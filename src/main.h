...
#ifndef NEWYORKCOIN_MAIN_H
#define NEWYORKCOIN_MAIN_H
...
static const int64_t MAX_SINGLE_TX = 100000000000 * COIN; // 100 Billion (Same As Cap)
/** Money Range Params */
...
public:
    ...
    /** Amount of Newyorkcoin spent by this transaction.
