    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("Newyorkcoin") + " - " + tr("Client"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("Newyorkcoin");
    setStyleSheet("#Newyorkcoin {background-image: url(:/images/qt) }"); //qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #499bea, stop: 1 #207ce5
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Newyorkcoin address"));
    ...
    messageAction->setToolTip(tr("Newyorkcoin secure messaging page"));
    ...
    blockbrowserAction->setToolTip(tr("Browse and access block details of the Newyorkcoin chain"));
    ...
    siteonChainAction->setToolTip(tr("Newyorkcoin Site on Blockchain (Websites on the Chain)"));
    ...
    aboutAction = new QAction(tr("&About Newyorkcoin"), this);
    aboutAction->setToolTip(tr("Show information about Newyorkcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Newyorkcoin"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #0F75BC; font-weight:bold;} QToolButton:hover { background-color: #6D6E71 } QToolButton:checked { background-color: #3e3e40 } QToolButton:pressed { background-color: #4B4B4D } #tabs { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #499bea, stop: 1 transparent); border: none }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Newyorkcoin client") + QString(" ") + tr("[testnet]"));
...
{
    QString strTitle = tr("Newyorkcoin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Newyorkcoin address or malformed URI parameters."));
    }
