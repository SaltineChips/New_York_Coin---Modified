...
#if defined(NEWYORKCOIN_NEED_QT_PLUGINS) && !defined(_NEWYORKCOIN_QT_PLUGINS_INCLUDED)
#define _NEWYORKCOIN_QT_PLUGINS_INCLUDED
#define __INSURE__
#include <QtPlugin>
...
int main(int argc, char *argv[])
{
    ...
    app.setOrganizationName("Newyorkcoin");
    app.setOrganizationDomain("CryptoCoderz.com");
    if(GetBoolArg("-testnet", false)) // Separate UI settings for testnet
        app.setApplicationName("Newyorkcoin-Qt-testnet");
    else
        app.setApplicationName("Newyorkcoin-Qt");
