...
"for example: alertnotify=echo %%s | mail -s \"Newyorkcoin Alert\" admin@foo."
"com\n"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. Newyorkcoin is shutting down."),
