...
void BlockBrowser::updateExplorer(bool block)
{
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " NYC");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " NYC");
    }
}
...
void BlockBrowser::updateStatistics()
{
    ...
    {
        ui->volumeBox_2->setText("<b><font color=\"green\">" + qVolume + " NYC" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox_2->setText("<b><font color=\"red\">" + qVolume + " NYC" + "</font></b>");
    } else {
        ui->volumeBox_2->setText(qVolume + " NYC");
    }
